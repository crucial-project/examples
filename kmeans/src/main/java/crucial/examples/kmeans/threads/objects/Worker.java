...
public class Worker implements Runnable {
    ...
    private GlobalDelta globalDelta;
    ...
    public Worker(int workerId, int dataPoints, int dimensions, int parallelism,
        ...
        this.globalCentroids = Main.globalCentroids;
        this.globalDelta = Main.globalDelta;
    }
    ...
    public void run() {
        ...
        do {
            ...
            // Wait for all workers to finish iteration
            try {
                int p = Main.barrier.await();
